...
public class QuestionsController {
	...
	///create new record
		...
		public ResponseEntity<QuizCompete> addQuiz(@RequestBody QuizCompete q){
			QuizCompete qui= service.addQuiz(q);
			if(qui!=null)  
				return new ResponseEntity<QuizCompete>(qui,HttpStatus.CREATED);
			else
				return new ResponseEntity<QuizCompete>(qui, HttpStatus.INTERNAL_SERVER_ERROR);
		}
